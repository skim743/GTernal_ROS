...
#include "firmware_interfaces/srv/detail/status__rosidl_typesupport_fastrtps_c.h"
...
using _Status_Request__ros_msg_type = firmware_interfaces__srv__Status_Request;
...
size_t get_serialized_size_firmware_interfaces__srv__Status_Request(
  const void * untyped_ros_message,
...
static uint32_t _Status_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_firmware_interfaces__srv__Status_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_firmware_interfaces
size_t max_serialized_size_firmware_interfaces__srv__Status_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = firmware_interfaces__srv__Status_Request;
    is_plain =
      (
...
static size_t _Status_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_firmware_interfaces__srv__Status_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firmware_interfaces, srv, Status_Request)() {
...
using _Status_Response__ros_msg_type = firmware_interfaces__srv__Status_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << (ros_message->charge_status ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: charge_status
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->charge_status = tmp ? true : false;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_firmware_interfaces
size_t get_serialized_size_firmware_interfaces__srv__Status_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Status_Response__ros_msg_type * ros_message = static_cast<const _Status_Response__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name charge_status
  {
    size_t item_size = sizeof(ros_message->charge_status);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_firmware_interfaces__srv__Status_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_firmware_interfaces
size_t max_serialized_size_firmware_interfaces__srv__Status_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firmware_interfaces__srv__Status_Response;
    is_plain =
      (
      offsetof(DataType, charge_status) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Status_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_firmware_interfaces__srv__Status_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firmware_interfaces, srv, Status_Response)() {
...
// already included above
// #include "firmware_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "firmware_interfaces/srv/status.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firmware_interfaces, srv, Status)() {
